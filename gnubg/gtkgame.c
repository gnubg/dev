...
static char ARHelp[3000] = "AutoRollout is a new experimental feature. "
        ...
        "To reduce rollouts, "
        "it further differs from eval analysis in two ways: "
...
static GtkActionEntry actionEntries[] = {
  ...
  { "AnalyseMenuAction", NULL, N_("_Analyse"), NULL, NULL, G_CALLBACK(NULL) },
    ...
    { "TemperatureMapAction", NULL, N_("Temperature Map (before roll)"), NULL, NULL,
     CMD_ACTION_CALLBACK_FROMID(CMD_SHOW_TEMPERATURE_MAP) },
    { "TemperatureMapCubeAction", NULL, N_("Temperature Map (cube)"), NULL, NULL,
     CMD_ACTION_CALLBACK_FROMID(CMD_SHOW_TEMPERATURE_MAP_CUBE) },
    { "ScoreMapCubeAction", NULL, N_("ScoreMap (cube)"), NULL, NULL,
     CMD_ACTION_CALLBACK_FROMID(CMD_SHOW_SCORE_MAP_CUBE) },
    { "ScoreMapMoveAction", NULL, N_("ScoreMap (move)"), NULL, NULL,
    ...
    {"GoPreviousMarkedMoveAction", GNUBG_STOCK_GO_PREV_MARKED, N_("Previous marked move"), "<shift><control>Page_Up",
     N_("Previous marked move"), CMD_ACTION_CALLBACK_FROMID(CMD_PREV_MARKED)},
    {"GoPreviousCMarkedMoveAction", GNUBG_STOCK_GO_PREV_CMARKED, N_("Previous cmarked move"), "<shift>Page_Up", N_("Previous cmarked move"),
     CMD_ACTION_CALLBACK_FROMID(CMD_PREV_CMARKED)},
    {"GoPreviousRollAction", GNUBG_STOCK_GO_PREV, N_("Previous rol_l"), "Page_Up", N_("Previous roll"),
     CMD_ACTION_CALLBACK_FROMID(CMD_PREV_ROLL)},
    {"GoPreviousGameAction", GNUBG_STOCK_GO_PREV_GAME, N_("Pre_vious game"), "<control>Page_Up", N_("Previous game"),
     CMD_ACTION_CALLBACK_FROMID(CMD_PREV_GAME)},
    {"GoNextGameAction", GNUBG_STOCK_GO_NEXT_GAME, N_("Next _game"), "<control>Page_Down", N_("Next game"),
     CMD_ACTION_CALLBACK_FROMID(CMD_NEXT_GAME)},
    {"GoNextRollAction", GNUBG_STOCK_GO_NEXT, N_("Next _roll"), "Page_Down", N_("Next roll"),
     CMD_ACTION_CALLBACK_FROMID(CMD_NEXT_ROLL)},
    {"GoNextCMarkedMoveAction", GNUBG_STOCK_GO_NEXT_CMARKED, N_("Next cmarked move"), "<shift>Page_Down", N_("Next cmarked move"),
     CMD_ACTION_CALLBACK_FROMID(CMD_NEXT_CMARKED)},
    {"GoNextMarkedMoveAction", GNUBG_STOCK_GO_NEXT_MARKED, N_("Next marked move"), "<shift><control>Page_Down", N_("Next marked move"),
...
static GtkItemFactoryEntry aife[] = {
    ...
    { N_("/_Analyse/Temperature Map (before roll)"), NULL, G_CALLBACK(Command),
     CMD_SHOW_TEMPERATURE_MAP, NULL, NULL },
    { N_("/_Analyse/Temperature Map (cube)"), NULL, G_CALLBACK(Command),
     CMD_SHOW_TEMPERATURE_MAP_CUBE, NULL, NULL },
    { N_("/_Analyse/ScoreMap (move)"), NULL, G_CALLBACK(Command),
     CMD_SHOW_SCORE_MAP_MOVE, NULL, NULL },
    { N_("/_Analyse/ScoreMap (cube)"), NULL, G_CALLBACK(Command),
...
UpdatePlayerSettings(newwidget * pnw)
{
    ...
    strcpy(ap[0].szName, default_names[0]);
    strcpy(ap[1].szName, default_names[1]);
    // g_message("names: %s / %s",ap[0].szName,default_names[0]);
...
GTKSet(void *p)
{
    ...
    if (p == ap) {
        ...
        */
        ...
        // => gtk_widget_set_sensitive and enable_menu only hide the sub-items, 
        // enable_sub_menu doesn't do anything...
        // it's not clear that hiding sub-items is better...
        // */
